...
| Dashboard / entrada por perfil | Dashboard admin e vista atleta/portal; estatísticas, eventos recentes, receitas, atividade | Membros, Eventos, Financeiro, Desportivo, Família | 66% | Bem encaminhado; F3.2 alinhou a leitura de conta corrente nas superfícies de membro/utilizador, mas falta validação manual final de UX e indicadores. |
| Portal do atleta / utilizador | Perfil, treinos, eventos, pagamentos, resultados, documentos, comunicados, família, loja | Desportivo, Eventos, Financeiro, Documentos, Comunicação, Loja | 63% | Estrutura existe; F3.2 alinhou Pagamentos e Família com `CurrentAccountService`, distinguindo dívida líquida, dívida bruta, crédito disponível e saldo manual legado. Falta validação manual de experiência real em mobile. |
...
| Família / EE / educandos | Portal família, pesquisa e associação de membros familiares | Membros, Portal, Dashboard, Financeiro familiar | 60% | F3.2 passou a somar dívida aberta real por educando/família com `CurrentAccountService`, excluindo faturas futuras/ocultas e separando crédito disponível/saldo manual legado. Falta validação manual orientada. |
