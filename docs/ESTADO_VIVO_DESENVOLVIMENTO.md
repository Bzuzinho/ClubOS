...
|---|---:|---|
| Base técnica / arquitetura | 89% | H0.1a/H0.1b/H0.2 concluídos em produção. H1.1 concluiu dependency remediation compatível e QA ratchets; H1.4/H1.5/H1.6 reduziram progressivamente a dívida TypeScript para 88 erros/44 ficheiros. Permanecem Laravel major, migração de `xlsx`, continuação do paydown TypeScript e hardenings residuais. |
...
| PWA / Mobile | 55% | H1.4/H1.5/H1.6 reduziram a dívida TypeScript de 132 erros/55 ficheiros para 88 erros/44 ficheiros e apertaram o ratchet anti-regressão para esse teto. Continuam em falta lint, unit/component tests, E2E, acessibilidade e matriz Android/iOS/tablet/desktop. |
...
- TypeScript começou com teto de 132 erros / 55 ficheiros; qualquer melhoria tem de baixar o baseline no mesmo PR. H1.4 reduziu-o para 123/51, H1.5 para 101/51 e H1.6 para o teto atual de 88 erros / 44 ficheiros;
...
### H1.6 — Dead code TypeScript guiado por concentração — PR #213
...
3. continuar o paydown dos 88 erros TypeScript por domínio; o maior ficheiro isolado é `Financeiro/BancoTab.tsx`, que deve ser tratado num lote próprio por ser fluxo financeiro crítico;
...
|---:|---|---|
| 1 | H1 | H1.1, H1.4, H1.5 e H1.6 concluídos/validados por lotes; continuar paydown TypeScript e avançar com Laravel major, migração de `xlsx`, hardening residual R2 e QA frontend. |
...
Próximo passo: continuar H1 por lotes pequenos e mensuráveis, reduzindo a dívida TypeScript a partir do teto 88/44 e mantendo os ratchets de segurança; em paralelo, preparar as mudanças incompatíveis de Laravel e `xlsx` sem degradar o runtime atual.
