...
|---|---|---|---|---|
| 2026-08-21 | Financeiro / Legacy cleanup | Aposentados os CRUDs legacy de transações e categorias financeiras com `410 Gone` e redirecionamento semântico para o Financeiro canónico; removido o último placeholder ativo de `Financeiro/Edit`, que passa a convergir para a tab canónica de Faturas. | PRs #179/#180; CI #678/#680; commits `6ea4c80bc0c8ef716f8c6ba6746c1aeb950dcb58` e `a45da50dd9ab6bd7afe2ece6deea04d4a36be7df` | Integrado em `main`, sem migrations nem alteração de dados. CI atual verde; a promoção produtiva do SHA final deve ser validada separadamente antes de ser registada como evidência de produção. |
