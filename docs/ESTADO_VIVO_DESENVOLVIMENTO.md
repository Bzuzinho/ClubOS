...
| 2026-06-17 | Financeiro | Sprint F4.2.3 — correção de interpretação funcional e fecho técnico. A sugestão deixou de funcionar como decisão fechada por uma única mensalidade e passou a abrir alocação assistida editável com todos os destinos elegíveis até ao mês de referência (mensalidades/faturas), movimentos de receita em aberto e crédito remanescente. A confirmação assistida mantém guardas de elegibilidade e limites de valor e continua a delegar para o fluxo canónico existente, sem reescrever pagamentos, desconciliação ou importação XLS. | `app/Services/Financeiro/BankReconciliationSuggestionService.php`, `resources/js/Pages/Financeiro/BancoTab.tsx`, `resources/js/Pages/Financeiro/BankStatementReconciliationDialog.tsx`, `resources/js/Pages/Financeiro/types.ts`, `tests/Feature/Financeiro/BankReconciliationSuggestionFlowTest.php`, `docs/PLANO_FECHO_MODULO_FINANCEIRO.md` | 92% | 93% | Tecnicamente concluída e validada por testes automáticos; validação manual orientada em browser ainda pendente. Não avançar para F4.3. |
