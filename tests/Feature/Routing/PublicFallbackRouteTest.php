...
final class PublicFallbackRouteTest extends TestCase
{
    public function test_public_fallback_is_loaded_from_the_dedicated_file_after_auth_and_compatibility_routes(): void
    {
        ...
        $fallbackRoutes = File::get(base_path('routes/public/web_fallback.php'));
        $route = Route::getRoutes()->getByName('public.custom-page');

        $this->assertStringContainsString("require __DIR__.'/public/web_fallback.php';", $webRoutes);
        ...
        $fallbackPosition = strpos($webRoutes, "require __DIR__.'/public/web_fallback.php';");
