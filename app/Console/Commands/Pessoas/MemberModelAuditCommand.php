...
final class MemberModelAuditCommand extends Command
{
    protected $signature = 'people:audit-member-model
        ...
        {--member= : Filtrar por ficha/member id}
        {--fail-on-warning : Exit code 1 se houver warnings}
        {--fail-on-critical : Exit code 1 se houver criticos}';

    protected $description = 'Auditoria read-only do modelo real de membro/utilizador';
